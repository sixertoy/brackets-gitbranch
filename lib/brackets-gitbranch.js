        ...
        _getBranches: function (url, current, root) {
            ...
            Branches.exec('get', path).done(function (branches) {
                ...
                if (branches.length > 1) {
                    ...
                    $($this).trigger('brackets-sixertoy-gitbranch.populate', [url, current, root, list]);
                } else {
                    $($this).trigger('brackets-sixertoy-gitbranch.populate', [true, current, root]);
                }
                //
            }).fail(function (err) {
                $($this).trigger('brackets-sixertoy-gitbranch.populate', [false]);
            });
        },
