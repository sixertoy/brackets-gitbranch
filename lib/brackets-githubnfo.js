...
define(function (require, exports, module) {
    ...
    var _bracketsPath   = FileUtils.getNativeBracketsDirectoryPath(),
        _nodePath       = "filesystem/impls/appshell/node/FileWatcherDomain",
        _domainPath     = [_bracketsPath, _nodePath].join("/");
    var Watcher = new NodeDomain('fileWatcher', _domainPath);
    ...
    Helper.prototype.initWatchChanges = function (path) {
        var $this = this,
            fileName = 'HEAD',
            fullPath = path + fileName;
        fullPath = 'D\\:\\www\\__github__\\brackets-githubnfo\\.git\\HEAD';
        $(Watcher).on("change", function () {

            console.log(arguments);

        });
        Watcher.exec("watchPath", fullPath).then(function () {
