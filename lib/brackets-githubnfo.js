...
define(function (require, exports, module) {
    ...
    Helper.prototype.watchRootChanges = function (path) {
        ...
        try {
            ...
            var entry = FileSystem.getFileForPath(path + 'HEAD');
            if (entry._isFile) {
                entry.exists(function (err) {
                    if (err !== null) {

                        console.log(entry);
                        console.log(entry._stat);
                        console.log(entry._isWatched());
                        console.log(entry._watchedRoot);
                        /*
                        $(entry._fileSystem).on('change', function () {
                            console.log('change change change change change change change');
